...
interface TTGrid {
    ...
    FixAbove(row: TRow): boolean | number;
    FixBelow(row: TRow): boolean | number;
    FixNext(col: string): boolean | number;
    FixPrev(col: string): boolean | number;
    Focus(
        row?: TRow,
        col?: string,
        pagepos?: number,
...
declare const Grids: TGrids;
declare const TGGrids: TGrids;
