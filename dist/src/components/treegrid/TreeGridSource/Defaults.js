TreeGridLoaded({
        ...
        'Formats': {
            Items: [
                ...
                { Name: '@Enter', Text: 'Enter custom format ...' },
                {
                    ...
                    Text: 'Custom formats',
                    Menu: '1',
                    Items: [{ Name: '-' }, { Name: '@Refresh', Text: 'Remove unused formats' }],
                },
                { Name: '-' },
    ...
    'Toolbar': {
        ...
        'SortVisibleFormula':
            'Grid.Sorting && (Grid.Paging==3||Grid.ChildPaging==3||Grid.Paging==1 && Grid.LoadedCount>300)',
    ...
    'Media': [
        { 'Style': 'TT', 'Cfg': { 'Alternate': '2', 'AlternateType': '3', 'ColorPanel': '1' } },
        {
